...
def pogoda(update: Update, context: CallbackContext) -> None:
    update.message.reply_text(f'Погода, {update.effective_user.first_name}', request_forecast(city_id))
...
updater.dispatcher.add_handler(CommandHandler('Погода', pogoda))	# информация о погоде
